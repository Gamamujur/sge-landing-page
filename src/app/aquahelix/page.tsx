                ...
                <div className="px-5 py-20 xl:px-0">
                    ...
                    <div className="relative z-50 w-2/3 mx-auto text-center max-w-7xl lg:w-1/2">
                        <div className="relative flex justify-center items-center">
                            <Image
                                className="z-10"
                                src="/img/solutions-and-product/aquahelix.svg"
                                width={319}
                                height={218}
                                alt="Aqua Clear Cube"
                            />
                        ...
                        >
                            ...
                            >
                                <Image
                                    ...
                                    src="/img/solutions-and-product/aquahelix-surface-aerator.svg"
                                    alt=""
                                />
                            ...
                            <Link
                                href={Translator.gotoUrl("/aquahelix-anaerobic-mixer", lang)}
                                className="relative flex flex-col items-center justify-end py-5 overflow-hidden transition duration-300 ease-in-out hover:rounded-2xl hover:font-bold hover:bg-[#EDF2F5]"
                            >
                                <Image
                                    width={100}
                                    height={100}
                                    className="w-full max-h-64"
                                    src="/img/solutions-and-product/aquahelix-anaerobic-mixer.svg"
                                    alt=""
                                />
                                <p className="mt-2 text-xl font-semibold text-center">
                                    Aquahelix Anaerobic Mixer
                                </p>
                            </Link>
                            <Link
                                href={Translator.gotoUrl("/bacteria", lang)}
                                className="relative flex flex-col items-center justify-end py-5 overflow-hidden transition duration-300 ease-in-out hover:rounded-2xl hover:font-bold hover:bg-[#EDF2F5]"
                            >
                                <Image
                                    width={100}
                                    height={100}
                                    className="w-full max-h-64 "
                                    src="/img/solutions-and-product/aquahelix-bacteria-booster.svg"
                                    alt=""
                                />
                                <p className="mt-2 text-xl font-semibold text-center">
                                    Aquahelix Bacteria Booster
                                </p>
                            </Link>
                        </div>
                    </div>
